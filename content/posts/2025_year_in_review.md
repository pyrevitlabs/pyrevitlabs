...
## 🚀 Product Progress & New Features

2025 delivered a steady stream of improvements across the **pyRevit 5.x series** — not just compatibility work, but real workflow upgrades and tooling polish.
...
## 🧩 Major Technical Work: The New C# Loader
...
- It modernizes pyRevit’s startup and integration layer
...
## 👥 Growing the Contributor Base (with Shout-Outs)

2025 also stood out for the **breadth of contributors** helping pyRevit move forward — through code, reviews, fixes, and community support.

Shout-outs to contributors credited throughout 2025 releases and updates:
- **@Wurschdhaud** — *great newcomer with impactful fixes*
- **@romangolev** — *major architectural work (C# loader)*
- **@tay0thman**
- **@MohamedAsli**
- **@Isaiah-Narvaez-42**
- **@WemyssJ**
...
- **@frank-e-loftus**
- **@IGF-Zhang**
- And the “usual suspects in the background”: **@sanzoghenzo** and **@dosymep**

If we missed a drive-by contributor who shipped a fix, reviewed a PR, or helped on the forum — thank you. The project is stronger because of your involvement.

---

## 💰 Open Collective — 2025 Financial Overview
...
|-------|----------------|-------------|
| **Maintenance & Development** | 4 | **−$1,133.73** |
| **Travel (community & events)** | 2 | **−$880.15** |
| **Hosting & Subscriptions** | 16 | **−$713.57** |
| **Advertising & Marketing** | 1 | **−$293.22** |
| **Total Expenses** | **23** | **−$3,020.67** |
...
This transition will be critical for pyRevit’s long-term future and will require:
...
If pyRevit saves you time, enables automation, or supports your team’s workflows, please consider supporting the project financially:

👉 **https://opencollective.com/pyrevitlabs**

Even small recurring contributions make a real difference — and directly support the people building the tools you rely on.
